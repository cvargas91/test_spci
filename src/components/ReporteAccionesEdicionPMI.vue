<template> 
    ...
    <div class="row justify-end q-gutter-sm q-ma-md" style="margin-right:2pt">
        <q-separator inset />
        ...
        setup(props, {emit}) {
            ...
            const model = computed({
                get:() => {
                    ...
                    indicador.value = props.reporteAccion.indicador;
                }
            })
            ...
            const cambioAdelante = async () => {
                ...
                emit('guardarReporte', "Finalizado");
            };

            const guardarAvanceReporte = async () => {
