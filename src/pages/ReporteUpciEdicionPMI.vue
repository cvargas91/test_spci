<template>
    ...
    >
        ...
        <q-card style="margin-right:0pt; margin-left:0pt; width:100%; padding-top:0%;padding-bottom:36pt">
            <q-card-section style="padding-bottom:1pt">
            ...
            <q-card-section style="padding-top:0pt" horizontal>
                <p style="padding-left:29%">
                    <strong style="text-align:center; color:#385280; font-size:10pt">
            ...
            <q-card-section style="height:40pt; padding-top:1%;margin-bottom:26pt">
                ...
                <div style="background-color:#d9e2f3; width:560pt; margin-right:0pt; margin-left:0pt; min-height:10pt; padding-right:40pt">
...
<script>
    ...
    import ReporteHitosEdicionPMI from "src/components/ReporteHitosEdicionPMI.vue";
    import ReporteAccionesEdicionPMI from "src/components/ReporteAccionesEdicionPMI.vue";
    ...
    export default defineComponent({
        ...
        setup() {
            ...
            const nuevaFuncion = async () => {
                if(model.value.reporte_funciones.length){
                    await store.dispatch("reporte/actualizaNuevoReporteFuncionPMI", acciones.value.funciones[0].indicador_set[0].id)
                }
            }
